...
const howItWorks = [
  { step: "Sign Up", description: "create your free calender account" },
  {
  ...
  },
  {
    ...
    description: "send your calendar link to clients or colleagues",
  },
  {
    step: "Get Booked",
    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">
            calendy helps you manage your time effectively. Create events,set
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">
          Join thousands of professionals who trust calendy for efficient time
          management.
        </p>
        <Link href="/dashboard">
